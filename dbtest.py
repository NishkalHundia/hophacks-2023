...
# userid = cur.execute("SELECT * FROM usertable")
# userid = cur.fetchall()
# print(userid)
...
# cur.execute("DELETE FROM userinfo WHERE user_id = 5")
# conn.commit()
# cur.execute("DELETE FROM userinfo WHERE user_id = 6")
# conn.commit()
# cur.execute("DELETE FROM userinfo WHERE user_id = 7")
# conn.commit()
# cur.execute("DELETE FROM userinfo WHERE user_id = 8")
# conn.commit()
# cur.execute("DELETE FROM userinfo WHERE user_id = 9")
# conn.commit()
